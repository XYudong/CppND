...
{    
    ...
    cout << "Please enter a float(0-100) for start_x: " << endl;
    start_x = GetFloat();
    cout << "Please enter a float(0-100) for start_y: " << endl;
    start_y = GetFloat();

    cout << "Please enter a float(0-100) for end_x: " << endl;
    end_x = GetFloat();
    cout << "Please enter a float(0-100) for end_y: " << endl;
    end_y = GetFloat();
