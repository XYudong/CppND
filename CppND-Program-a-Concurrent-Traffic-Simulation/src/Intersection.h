...
private:
    std::queue<std::shared_ptr<Vehicle>> _vehicles;          // list of all vehicles waiting to enter this intersection
    std::queue<std::promise<void>> _promises; // list of associated promises
    std::mutex _mutex;
};
